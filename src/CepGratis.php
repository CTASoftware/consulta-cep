...
namespace CTASoftware\CepGratis;

use CTASoftware\CepGratis\Clients\CurlHttpClient;
use CTASoftware\CepGratis\Contracts\HttpClientContract;
use CTASoftware\CepGratis\Contracts\ProviderContract;
use CTASoftware\CepGratis\Exceptions\CepGratisInvalidParameterException;
use CTASoftware\CepGratis\Exceptions\CepGratisTimeoutException;
use CTASoftware\CepGratis\Providers\CorreiosProvider;
use CTASoftware\CepGratis\Providers\ViaCepProvider;
use CTASoftware\CepGratis\Providers\ToolsWebProvider;
...
class CepGratis
{
    ...
    {
        $cepGratis = new self();
        $cepGratis->addProvider(new ToolsWebProvider());
